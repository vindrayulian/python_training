# Menambahkan fitur berbeda komentar sesuai skor
...
# Komentar motivasi berdasarkan skor
if skor == 0:
    print("Jangan menyerah! Setiap ahli pernah salah 💪")
elif skor <= 5:
    print("Tingkatkan terus! Kamu sudah berusaha 👍")
elif skor <= 10:
    print("Lumayan! Sedikit lagi bisa lebih baik 😄")
elif skor <= 15:
    print("Hebat! Pengetahuanmu keren 👏")
elif skor < len(teka_teki):
    print("Hampir sempurna! Sedikit lagi menuju juara 🏅")
else:
    print("Kamu luar biasa! Semua benar! 🏆")
